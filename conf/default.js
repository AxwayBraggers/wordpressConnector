...
module.exports = {
	...
	session: {
		...
		encryptionKey: 'NZuY0dNw65mZWVTkivjxSM/NdZQO9MRt3tLszbRjCUo=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'iopBZZKgcCZlJQQoxNOmQCxYaZvdTeVmIPALgO+IjlMn0+TrDKvk7JTviJSniN0cRWRz7/Vm0FnNKv+VMJB2vg==',
		secret: 'abuhHNzLarfC0MAQTHRPpwFoxAa2HneI', // should be a large unguessable string
